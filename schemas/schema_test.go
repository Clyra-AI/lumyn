...
var requiredSchemas = []string{
	...
	"provider-change-event.schema.json",
	"migration-pack.schema.json",
	"consumer-installation.schema.json",
	"event-authorization.schema.json",
	"consumer-execution-manifest.schema.json",
	"managed-credential-grant.schema.json",
	"integration-graph.schema.json",
	"impact-report.schema.json",
	"migration-plan.schema.json",
	"candidate-manifest.schema.json",
	"agent-runner-manifest.schema.json",
	"agent-runner-conformance-result.schema.json",
	"agent-attempt.schema.json",
	"migration-verification.schema.json",
	"export-result.schema.json",
	"campaign-summary.schema.json",
	"provider-status-projection.schema.json",
	"remediation-outcome.schema.json",
}
