...
- Runner-ready task packets must declare `worker_type`, `factoryd_runtime`, `validation_commands`, `max_iterations`, `evidence_required`, and `stop_conditions` before daemon dispatch.
