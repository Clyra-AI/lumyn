...
Live eval provider endpoints, including custom `base_url` endpoints, stay blocked until the repo records a complete `model_provider_endpoint` grant; generic network or credential approval is not enough.
